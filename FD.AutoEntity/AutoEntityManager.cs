...
namespace FD.AutoEntity
{
    public class AutoEntityManager : IAutoEntityManager
    {
        ...
        public List<Type> AutoEntityList { get; set; } = new List<Type>();
        public void Create(classDefineModel model)
        {
            ...
            */
            ...
            ModuleBuilder mb =
                ab.DefineDynamicModule(model.moduleName);
            ///定义类
            ///
            TypeBuilder tb = null;
            ...
            foreach (var item in model.propertyDefineModels)
            {
                ...
                numberGetIL.Emit(OpCodes.Ldfld, privatefield);
                numberGetIL.Emit(OpCodes.Ret);

                // Define the "set" accessor method for Number, which has no return
                // type and takes one argument of type int (Int32).
                MethodBuilder mbNumberSetAccessor = tb.DefineMethod(
                    "set_" + item.propertyName,
                    getSetAttr,
                    null,
                ...
                numberSetIL.Emit(OpCodes.Stfld, privatefield);
